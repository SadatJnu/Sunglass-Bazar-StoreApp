...
namespace SunglassStoreServer.Controllers
{
    ...
    */
    //[EnableCors(origins: "http://localhost:2295/", headers: "*", methods: "*")]
    [EnableCors("*","*","*")]
    public class ProductsController : ODataController
    {
        ...
        // GET: odata/Products(5)/RecentlyViews
        [EnableQuery]
        public IQueryable<RecentlyView> GetRecentlyViews([FromODataUri] int key)
        {
            return db.Products.Where(m => m.ProductID == key).SelectMany(m => m.RecentlyViews);
        }
